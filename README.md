[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=18458713)
...
## Логіка
Перебираємо масив, і якщо зустрічається цифра '4' або підряд йдуть цифри '1' та '3', збільшуємо лічильник на 1.
</br>
![count](count.png)

## Тестування
Створюємо функцію яка генерує масив на 100000 номерів, та викликає функцію count та передаємо масив. Після виводимо результат.
</br>
![count](TestCount.png)

## Результат
Тестуємо написаний код 
</br>
![count](rescount.png)